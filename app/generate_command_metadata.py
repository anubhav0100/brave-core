...
SUPPORTED_CHROMIUM_COMMANDS = [
    ...
    "IDC_FOCUS_MENU_BAR",
    "IDC_FOCUS_NEXT_PANE",
    "IDC_FOCUS_NEXT_TAB_GROUP",
    "IDC_FOCUS_PREV_TAB_GROUP",
...
EXISTING_TRANSLATIONS = {
    ...
    "IDC_SHOW_COMPUTER_USE": "IDS_SHOW_COMPUTER_USE",
    "IDC_NEW_AI_CHAT_AGENT_PROFILE": "IDS_NEW_AI_CHAT_AGENT_PROFILE",
    ...
    "IDC_SHOW_READING_MODE_KEYBOARD": "IDS_SHOW_READING_MODE_SIDE_PANEL",
    "IDC_TOGGLE_VERTICAL_TABS_COLLAPSE": "IDS_COLLAPSE_VERTICAL_TABS",
}
