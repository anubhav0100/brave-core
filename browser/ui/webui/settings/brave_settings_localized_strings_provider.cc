...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveLeoAssistantContentIndexingLabel",
       IDS_SETTINGS_LEO_ASSISTANT_CONTENT_INDEXING_LABEL},
      {"braveLeoAssistantContentIndexingDesc",
       IDS_SETTINGS_LEO_ASSISTANT_CONTENT_INDEXING_DESC},
      {"braveLeoAssistantContentIndexingItemCount",
       IDS_SETTINGS_LEO_ASSISTANT_CONTENT_INDEXING_ITEM_COUNT},
      {"braveLeoAssistantContentIndexingUnavailable",
       IDS_SETTINGS_LEO_ASSISTANT_CONTENT_INDEXING_UNAVAILABLE},
      {"braveLeoAssistantContentIndexingClearButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_CONTENT_INDEXING_CLEAR_BUTTON_LABEL},
      {"braveLeoAssistantRollingSummarizationLabel",
       IDS_SETTINGS_LEO_ASSISTANT_ROLLING_SUMMARIZATION_LABEL},
      {"braveLeoAssistantRollingSummarizationDesc",
       IDS_SETTINGS_LEO_ASSISTANT_ROLLING_SUMMARIZATION_DESC},
      {"braveLeoAssistantModelFallbackLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_FALLBACK_LABEL},
      {"braveLeoAssistantModelFallbackDesc",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_FALLBACK_DESC},
      {"braveLeoAssistantModelFallbackModelLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_FALLBACK_MODEL_LABEL},
      ...
      {"braveLeoAssistantInputModelUseResponsesApi",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_USE_RESPONSES_API_TOGGLE},
      {"braveLeoAssistantInputModelUseResponsesApiTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_USE_RESPONSES_API_TOOLTIP_INFO},
      ...
      {"braveLeoAssistantFetchModelsButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_FETCH_MODELS_BUTTON_LABEL},
      {"braveLeoAssistantFetchModelsTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_FETCH_MODELS_TOOLTIP_INFO},
      {"braveLeoAssistantNoModelsFoundError",
       IDS_SETTINGS_LEO_ASSISTANT_NO_MODELS_FOUND_ERROR},
      {"braveLeoAssistantFetchModelsError",
       IDS_SETTINGS_LEO_ASSISTANT_FETCH_MODELS_ERROR},
      {"braveLeoAssistantSelectFetchedModelLabel",
       IDS_SETTINGS_LEO_ASSISTANT_SELECT_FETCHED_MODEL_LABEL},
      {"pageCaptureSectionTitle", IDS_SETTINGS_PAGE_CAPTURE_SECTION_TITLE},
      {"pageCaptureSectionDesc", IDS_SETTINGS_PAGE_CAPTURE_SECTION_DESC},
      {"pageCaptureRefreshButtonLabel",
       IDS_SETTINGS_PAGE_CAPTURE_REFRESH_BUTTON_LABEL},
      {"pageCaptureSessionEntriesTitle",
       IDS_SETTINGS_PAGE_CAPTURE_SESSION_ENTRIES_TITLE},
      {"pageCaptureNoEntriesLabel",
       IDS_SETTINGS_PAGE_CAPTURE_NO_ENTRIES_LABEL},
      {"pageCaptureActivityLogTitle",
       IDS_SETTINGS_PAGE_CAPTURE_ACTIVITY_LOG_TITLE},
      {"pageCaptureNoLogLabel", IDS_SETTINGS_PAGE_CAPTURE_NO_LOG_LABEL},
      {"webhookToolsSectionTitle", IDS_SETTINGS_WEBHOOK_TOOLS_SECTION_TITLE},
      {"webhookToolsSectionDesc", IDS_SETTINGS_WEBHOOK_TOOLS_SECTION_DESC},
      {"webhookToolsNoToolsLabel",
       IDS_SETTINGS_WEBHOOK_TOOLS_NO_TOOLS_LABEL},
      {"webhookToolsAddNewButtonLabel",
       IDS_SETTINGS_WEBHOOK_TOOLS_ADD_NEW_BUTTON_LABEL},
      {"webhookToolAddDialogTitle",
       IDS_SETTINGS_WEBHOOK_TOOL_ADD_DIALOG_TITLE},
      {"webhookToolEditDialogTitle",
       IDS_SETTINGS_WEBHOOK_TOOL_EDIT_DIALOG_TITLE},
      {"webhookToolNameLabel", IDS_SETTINGS_WEBHOOK_TOOL_NAME_LABEL},
      {"webhookToolNamePlaceholder",
       IDS_SETTINGS_WEBHOOK_TOOL_NAME_PLACEHOLDER},
      {"webhookToolNameHint", IDS_SETTINGS_WEBHOOK_TOOL_NAME_HINT},
      {"webhookToolDescriptionLabel",
       IDS_SETTINGS_WEBHOOK_TOOL_DESCRIPTION_LABEL},
      {"webhookToolDescriptionPlaceholder",
       IDS_SETTINGS_WEBHOOK_TOOL_DESCRIPTION_PLACEHOLDER},
      {"webhookToolUrlLabel", IDS_SETTINGS_WEBHOOK_TOOL_URL_LABEL},
      {"webhookToolSecretLabel", IDS_SETTINGS_WEBHOOK_TOOL_SECRET_LABEL},
      {"webhookToolSecretPlaceholder",
       IDS_SETTINGS_WEBHOOK_TOOL_SECRET_PLACEHOLDER},
      {"webhookToolSecretEditHint",
       IDS_SETTINGS_WEBHOOK_TOOL_SECRET_EDIT_HINT},
      {"webhookToolParametersLabel",
       IDS_SETTINGS_WEBHOOK_TOOL_PARAMETERS_LABEL},
      {"webhookToolParametersHint",
       IDS_SETTINGS_WEBHOOK_TOOL_PARAMETERS_HINT},
      {"webhookToolEnabledLabel", IDS_SETTINGS_WEBHOOK_TOOL_ENABLED_LABEL},
      {"webhookToolDeleteConfirmationTitle",
       IDS_SETTINGS_WEBHOOK_TOOL_DELETE_CONFIRMATION_TITLE},
      {"webhookToolDeleteConfirmation",
       IDS_SETTINGS_WEBHOOK_TOOL_DELETE_CONFIRMATION},
      {"aiChatHistorySectionTitle", IDS_SETTINGS_AI_CHAT_HISTORY_SECTION_TITLE},
      {"aiChatHistorySectionDesc", IDS_SETTINGS_AI_CHAT_HISTORY_SECTION_DESC},
      {"aiChatHistoryRefreshButtonLabel",
       IDS_SETTINGS_AI_CHAT_HISTORY_REFRESH_BUTTON_LABEL},
      {"aiChatHistoryNoConversationsLabel",
       IDS_SETTINGS_AI_CHAT_HISTORY_NO_CONVERSATIONS_LABEL},
      {"aiChatHistoryUntitledLabel",
       IDS_SETTINGS_AI_CHAT_HISTORY_UNTITLED_LABEL},
      {"workflowsSectionTitle", IDS_SETTINGS_WORKFLOWS_SECTION_TITLE},
      {"workflowsSectionDesc", IDS_SETTINGS_WORKFLOWS_SECTION_DESC},
      {"workflowsNoWorkflowsLabel", IDS_SETTINGS_WORKFLOWS_NO_WORKFLOWS_LABEL},
      {"workflowsRunButtonLabel", IDS_SETTINGS_WORKFLOWS_RUN_BUTTON_LABEL},
      {"workflowsPublishButtonLabel",
       IDS_SETTINGS_WORKFLOWS_PUBLISH_BUTTON_LABEL},
      {"workflowsAddNewButtonLabel",
       IDS_SETTINGS_WORKFLOWS_ADD_NEW_BUTTON_LABEL},
      {"workflowsEditDialogTitle", IDS_SETTINGS_WORKFLOWS_EDIT_DIALOG_TITLE},
      {"workflowsDeleteConfirmationTitle",
       IDS_SETTINGS_WORKFLOWS_DELETE_CONFIRMATION_TITLE},
      {"workflowsDeleteConfirmation",
       IDS_SETTINGS_WORKFLOWS_DELETE_CONFIRMATION},
      {"n8nTerminalSectionTitle", IDS_SETTINGS_N8N_TERMINAL_SECTION_TITLE},
      {"n8nTerminalSectionDesc", IDS_SETTINGS_N8N_TERMINAL_SECTION_DESC},
      {"n8nTerminalStatusRunning", IDS_SETTINGS_N8N_TERMINAL_STATUS_RUNNING},
      {"n8nTerminalStatusStopped", IDS_SETTINGS_N8N_TERMINAL_STATUS_STOPPED},
      {"n8nTerminalStartLabel", IDS_SETTINGS_N8N_TERMINAL_START_LABEL},
      {"n8nTerminalStartingLabel", IDS_SETTINGS_N8N_TERMINAL_STARTING_LABEL},
      {"n8nTerminalClearViewLabel",
       IDS_SETTINGS_N8N_TERMINAL_CLEAR_VIEW_LABEL},
      {"n8nTerminalEmptyLabel", IDS_SETTINGS_N8N_TERMINAL_EMPTY_LABEL},
      {"delegationTerminalSectionTitle",
       IDS_SETTINGS_DELEGATION_TERMINAL_SECTION_TITLE},
      {"delegationTerminalSectionDesc",
       IDS_SETTINGS_DELEGATION_TERMINAL_SECTION_DESC},
      {"delegationTerminalStatusRunning",
       IDS_SETTINGS_DELEGATION_TERMINAL_STATUS_RUNNING},
      {"delegationTerminalStatusStopped",
       IDS_SETTINGS_DELEGATION_TERMINAL_STATUS_STOPPED},
      {"delegationTerminalStartLabel",
       IDS_SETTINGS_DELEGATION_TERMINAL_START_LABEL},
      {"delegationTerminalStartingLabel",
       IDS_SETTINGS_DELEGATION_TERMINAL_STARTING_LABEL},
      {"delegationTerminalClearViewLabel",
       IDS_SETTINGS_DELEGATION_TERMINAL_CLEAR_VIEW_LABEL},
      {"delegationTerminalEmptyLabel",
       IDS_SETTINGS_DELEGATION_TERMINAL_EMPTY_LABEL},
      {"n8nMcpConnectionsTitle", IDS_SETTINGS_N8N_MCP_CONNECTIONS_TITLE},
      {"n8nMcpConnectionsDesc", IDS_SETTINGS_N8N_MCP_CONNECTIONS_DESC},
      {"n8nMcpConnectionsEmptyLabel",
       IDS_SETTINGS_N8N_MCP_CONNECTIONS_EMPTY_LABEL},
      {"n8nMcpConnectedLabel", IDS_SETTINGS_N8N_MCP_CONNECTED_LABEL},
      {"n8nMcpDisconnectedLabel", IDS_SETTINGS_N8N_MCP_DISCONNECTED_LABEL},
      ...
      {"braveLeoAssistantColibriTitle",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_TITLE},
      {"braveLeoAssistantColibriDesc",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DESC},
      {"braveLeoAssistantColibriExecutablePathLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_EXECUTABLE_PATH_LABEL},
      {"braveLeoAssistantColibriExecutablePathPlaceholder",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_EXECUTABLE_PATH_PLACEHOLDER},
      {"braveLeoAssistantColibriModelPathLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_MODEL_PATH_LABEL},
      {"braveLeoAssistantColibriModelPathPlaceholder",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_MODEL_PATH_PLACEHOLDER},
      {"braveLeoAssistantColibriStatusRunning",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_STATUS_RUNNING},
      {"braveLeoAssistantColibriStatusStopped",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_STATUS_STOPPED},
      {"braveLeoAssistantColibriStartLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_START_LABEL},
      {"braveLeoAssistantColibriStartingLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_STARTING_LABEL},
      {"braveLeoAssistantColibriSyncLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_SYNC_LABEL},
      {"braveLeoAssistantColibriDownloadTitle",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_TITLE},
      {"braveLeoAssistantColibriDownloadDesc",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_DESC},
      {"braveLeoAssistantColibriDownloadRepoPlaceholder",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_REPO_PLACEHOLDER},
      {"braveLeoAssistantColibriDownloadOutdirPlaceholder",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_OUTDIR_PLACEHOLDER},
      {"braveLeoAssistantColibriDownloadButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_BUTTON_LABEL},
      {"braveLeoAssistantColibriDownloadStopLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_STOP_LABEL},
      {"braveLeoAssistantColibriLoadModelButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_LOAD_MODEL_BUTTON_LABEL},
      {"braveLeoAssistantColibriDownloadInProgressLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_IN_PROGRESS_LABEL},
      {"braveLeoAssistantColibriDownloadDoneLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_DONE_LABEL},
      {"braveLeoAssistantColibriDownloadErrorLabel",
       IDS_SETTINGS_LEO_ASSISTANT_COLIBRI_DOWNLOAD_ERROR_LABEL},
